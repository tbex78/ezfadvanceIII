...
SAVE_MEMORY_SOURCES = src/save_bank_access.cpp src/save_bank_cleaner.cpp src/save_memory_reader.cpp src/save_memory_writer.cpp src/save_bank_selector.cpp
SAVE_CATALOG_SOURCES = src/save_access_planner.cpp src/save_catalog_analyzer.cpp src/save_catalog_presenter.cpp src/save_output_path.cpp
SAVE_READER_SOURCES = $(READ_ONLY_SOURCES) $(SAVE_MEMORY_SOURCES) $(SAVE_CATALOG_SOURCES) src/save_reader_application.cpp src/save_reader_options.cpp src/save_file_store.cpp src/save_bank_workflow.cpp
WIPE_SOURCES = $(TRANSPORT_SOURCES) src/card_wipe_workflow.cpp src/flash_window_selector.cpp src/save_bank_access.cpp src/save_bank_cleaner.cpp
...
test: check
	...
	./build/protocol_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/flash_window_selector_test.cpp src/flash_window_selector.cpp src/protocol.cpp src/usb_device.cpp $(ALL_LDLIBS) -o build/flash_window_selector_test
	./build/flash_window_selector_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/usb_device_test.cpp src/usb_device.cpp $(ALL_LDLIBS) -o build/usb_device_test
	./build/usb_device_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/platform_test.cpp src/platform.cpp -o build/platform_test
	./build/platform_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/progress_bar_test.cpp src/progress_bar.cpp src/platform.cpp -o build/progress_bar_test
	...
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/save_catalog_presenter_test.cpp src/save_catalog_presenter.cpp -o build/save_catalog_presenter_test
	./build/save_catalog_presenter_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/save_output_path_test.cpp src/save_output_path.cpp -o build/save_output_path_test
	./build/save_output_path_test
	...
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/save_bank_cleaner_test.cpp src/save_bank_access.cpp src/save_bank_cleaner.cpp src/protocol.cpp src/usb_device.cpp $(ALL_LDLIBS) -o build/save_bank_cleaner_test
	./build/save_bank_cleaner_test
	$(CXX) $(ALL_CPPFLAGS) $(ALL_CXXFLAGS) tests/card_wipe_workflow_test.cpp src/card_wipe_workflow.cpp src/flash_window_selector.cpp src/save_bank_access.cpp src/save_bank_cleaner.cpp src/protocol.cpp src/usb_device.cpp $(ALL_LDLIBS) -o build/card_wipe_workflow_test
	./build/card_wipe_workflow_test
