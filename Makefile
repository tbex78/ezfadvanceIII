...
SAVE_READER_SOURCES = $(READ_ONLY_SOURCES) src/save_reader_options.cpp src/save_access_planner.cpp src/save_file_store.cpp src/save_bank_workflow.cpp src/save_catalog_analyzer.cpp src/save_catalog_presenter.cpp src/save_bank_access.cpp src/save_bank_cleaner.cpp src/save_memory_reader.cpp src/save_memory_writer.cpp src/save_bank_selector.cpp
