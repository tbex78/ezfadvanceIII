...
**Current project/toolset version:** `0.19.5`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.19.5`<br>
...
At shared source version **0.19.5**, the project has an object-oriented structural model:
