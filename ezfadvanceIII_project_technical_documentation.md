...
**Current project/toolset version:** `0.17.2`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.17.2`<br>
...
At shared source version **0.17.2**, the project has an object-oriented structural model:
