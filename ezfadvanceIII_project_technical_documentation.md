...
**Current project/toolset version:** `0.14.0`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.14.0`<br>
...
At shared toolset version **0.14.0**, the project has an object-oriented structural model:
