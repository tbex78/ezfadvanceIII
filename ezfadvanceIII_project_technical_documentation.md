...
**Current project/toolset version:** `0.20.1`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.20.1`<br>
...
At shared source version **0.20.1**, the project has an object-oriented structural model:
