...
**Current project/toolset version:** `0.20.6`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.20.6`<br>
...
At shared source version **0.20.6**, the project has an object-oriented structural model:
