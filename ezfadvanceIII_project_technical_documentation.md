...
**Current project/toolset version:** `0.17.3`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.17.3`<br>
...
At shared source version **0.17.3**, the project has an object-oriented structural model:
