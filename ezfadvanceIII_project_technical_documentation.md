...
**Current project/toolset version:** `0.18.0`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.18.0`<br>
...
At shared source version **0.18.0**, the project has an object-oriented structural model:
