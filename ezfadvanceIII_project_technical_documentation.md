...
**Current project/toolset version:** `0.7.2`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.7.2`<br>
...
**Host implementation:** object-oriented C++17 + libusb; native project scope is macOS, Linux, and BSD. The current shared 0.7.2 toolset and its refactored architecture have been compiled and hardware-tested on macOS / Apple Silicon; Linux/BSD validation remains pending.
...
```text
macOS       supported target; current 0.7.2 baseline derives from code compiled on Apple Silicon
...
At shared toolset version **0.7.2**, the project has an object-oriented structural model:
