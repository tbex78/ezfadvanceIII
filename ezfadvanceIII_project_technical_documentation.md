...
**Current project/toolset version:** `0.13.1`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.13.1`<br>
...
At shared toolset version **0.13.1**, the project has an object-oriented structural model:
