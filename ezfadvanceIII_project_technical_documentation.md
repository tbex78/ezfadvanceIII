...
**Current project/toolset version:** `0.19.1`<br>
**Current writer implementation:** `ezfadvanceIII_multirom_writer 0.19.1`<br>
...
At shared source version **0.19.1**, the project has an object-oriented structural model:
