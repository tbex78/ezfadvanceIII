...
Current shared project/toolset version covered by this summary: **0.13.1**.
...
Shared version 0.13.1 extends the C++17/libusb platform policy while preserving
the established Unix-like build path:

```text
macOS       target; current 0.13.1 baseline derives from code compiled on Apple Silicon/Homebrew
