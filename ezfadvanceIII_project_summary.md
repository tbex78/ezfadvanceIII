...
Current shared project/toolset version covered by this summary: **0.17.1**.
...
Shared version 0.17.1 follows the C++17/libusb platform policy while preserving
the established Unix-like build path:

```text
macOS       target; 0.15.2 baseline compiled on Apple Silicon/Homebrew; current 0.17.1 source awaits validation
