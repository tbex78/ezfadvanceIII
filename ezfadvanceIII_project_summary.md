...
Current shared project/toolset version covered by this summary: **0.15.1**.
...
Shared version 0.15.1 follows the C++17/libusb platform policy while preserving
the established Unix-like build path:

```text
macOS       target; current 0.15.1 baseline derives from code compiled on Apple Silicon/Homebrew
