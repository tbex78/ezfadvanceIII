...
Current shared project/toolset version covered by this summary: **0.19.6**.
...
Shared version 0.19.6 follows the C++17/libusb platform policy while preserving
the established Unix-like build path:

```text
macOS       target; 0.15.2 baseline compiled on Apple Silicon/Homebrew; current 0.19.6 source awaits validation
