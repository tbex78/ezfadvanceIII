...
Current shared project/toolset version covered by this summary: **0.14.3**.
...
Shared version 0.14.3 follows the C++17/libusb platform policy while preserving
the established Unix-like build path:

```text
macOS       target; current 0.14.3 baseline derives from code compiled on Apple Silicon/Homebrew
